...
uint32_t PWM_ConfigOutputChannelf(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Frequency, float u32DutyCycle)
{
	...
	(pwm)->CTL1 = ((pwm)->CTL1 & ~((0x3ul << (0)) << (2 * u32ChannelNum))) | (0UL << (2 * u32ChannelNum));
	(pwm)->CTL1 &= ~((0x1ul << (16)) << u32ChannelNum);

    if(u32DutyCycle == 100)
    {
        (*(volatile uint32_t *) (&((pwm)->CMPDAT0) + (u32ChannelNum)) = (u16CNR));
        (*(volatile uint32_t *) (&((pwm)->PERIOD0) + (u32ChannelNum)) = (--u16CNR));        
    }
    else
    {
	(*(volatile uint32_t *) (&((pwm)->CMPDAT0) + (u32ChannelNum)) = ((uint32_t)(u32DutyCycle * (u16CNR + 1) / 100 - 1)));
	(*(volatile uint32_t *) (&((pwm)->PERIOD0) + (u32ChannelNum)) = (--u16CNR));
    }

	(pwm)->WGCTL0 = ((pwm)->WGCTL0 & ~((0x3ul << (0)) << (u32ChannelNum * 2 + (0x3ul << (0)))))
                    | ((2UL) << (u32ChannelNum * 2 + (0)));
	(pwm)->WGCTL1 = ((pwm)->WGCTL1 & ~((0x3ul << (0)) << (u32ChannelNum * 2 + (0))))
                    | ((1UL) << (u32ChannelNum * 2 + (0)));
	return(i);
}
#line 106 "motors.c"
void motorsStart()
{
	...
	PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x1UL));
	PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x2UL));
	PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x4UL));
...
void motorsInit()
{
	...
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPL = (((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPL 
	& (~(0xful << (0)))
	& (~(0xful << (4)))
	& (~(0xful << (8)))
	& (~(0xful << (12)))
	...
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPL |= ((6ul << (0))|(6ul << (4))|
	(6ul << (8))|(6ul << (12))
	...
	PWM_ConfigOutputChannelf(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 0, 400, 400/10);
	PWM_ConfigOutputChannelf(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 1, 400, 400/10);
	PWM_ConfigOutputChannelf(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 2, 400, 400/10);
	PWM_ConfigOutputChannelf(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), 3, 400, 400/10);
	...
	PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x1UL));
	PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x2UL));
	PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)), (0x4UL));
...
void motorsSetRatio(int id, uint16_t u16PulseWidth)
{
    ...
    u32CNR = (*(volatile uint32_t *) (&((((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)))->PERIOD0) + (id)));
    if(u16PulseWidth >= 2000)
        u32CMR = u32CNR+1;
    else if(u16PulseWidth == 0)
        u32CMR = 0;
    else
        u32CMR = (float)u16PulseWidth*0.0004f* u32CNR;     

    (*(volatile uint32_t *) (&((((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x18000)))->CMPDAT0) + (id)) = (u32CMR));
...
{
  GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04100)),0x00001000,0x1UL);
  GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04100)),0x00002000,0x1UL);
  GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x040C0)),0x00000080,0x1UL);
...
void SetMotorCal()
{
  char token0 = GetChar();
    ...
    char token1 = GetChar();
    if(token1=='o') { 
      MotorCal.MotorOffset[0] = GetPIDfloat();
    }
    else if(token1=='s') { 
      MotorCal.MotorScale[0] = GetPIDfloat();
    }
  }
  else if(token0=='r') { 
    char token1 = GetChar();
    if(token1=='o') { 
      MotorCal.MotorOffset[1] = GetPIDfloat();
    }
    else if(token1=='s') { 
      MotorCal.MotorScale[1] = GetPIDfloat();
    }
  }
}
