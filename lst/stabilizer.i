...
#line 17 "stabilizer.c"
#line 18 "stabilizer.c"
#line 1 "Def.h"
...
#line 20 "stabilizer.c"
#line 21 "stabilizer.c"
#line 1 "controller.h"
...
#line 23 "stabilizer.c"
#line 24 "stabilizer.c"
...
_Bool getMagMode(void);
_Bool getHeadFreeMode(void);
_Bool isArmMinThrottle(void);
_Bool IsMotorSpin(void);
...
#line 29 "stabilizer.c"
#line 43 "stabilizer.c"
static float gyro[3]; 
...
static _Bool magMode = 0;
static _Bool headFreeMode = 0;
int16_t  motor_enable=1;
ACTUATOR_T Actuator;

uint32_t motorPowerM[6];

BLDC_MOTOR_T BLDC_MOTOR[6];
...
void DetectFlip()
{
	if(eulerRollActual>10)
		flip = 1;
	else if(eulerRollActual<-10)
		flip = 1;
	
	if(eulerPitchActual>30)
		flip = 1;
	else if(eulerPitchActual<-30)
		flip = 1;
}
float GetAccWZ()
{
...
{
	int16_t rcData[6], rc_roll, rc_pitch, rc_yaw, rc_aux2;
	
	getRC(rcData);
	rc_roll = (rcData[0] - 1500);
	rc_pitch = (rcData[1] - 1500);
	rc_yaw = (rcData[2] - 1500);
	rc_aux2 = rcData[5];
  ...
  if(!magMode)
		...
		magMode = 1;
		headFreeMode = 0;
#line 169 "stabilizer.c"
	if(headFreeMode) { 
		float radDiff = (headFreeHold - eulerYawActual) * 0.0174533f; 
	...
	if (fabs(rc_yaw)<50) {
		...
		if(rc_yaw>0)
			eulerYawDesired = (rc_yaw*80/(1920-1500));
		else
			eulerYawDesired = -(rc_yaw*80/(1090-1500));
	}

	if(rc_roll>10)
		eulerRollDesired = (rc_roll*10/(1920-1500));
	else if(rc_roll<-10)
		eulerRollDesired = -(rc_roll*10/(1090-1500));
	else
    eulerRollDesired = 0;
	
	if(rc_pitch>10)
		eulerPitchDesired = (rc_pitch*30/(1920-1500));
	else if(rc_pitch<-10)
		eulerPitchDesired = -(rc_pitch*30/(1090-1500));
	else
    eulerPitchDesired = 0;
}
void commanderGetThrust()
{
	int16_t rcData[6], rc_thrust;
  ...
  Actuator.actuatorThrust = (rcData[1] - 1500)*30;
  speedDesired = Actuator.actuatorThrust/10;
#line 255 "stabilizer.c"
}
_Bool isArmMinThrottle()
{
	if((int)Actuator.actuatorThrust<=(1100 - 1090))
		return 1;
	else
		return 0;
}
                            ...
                            int16_t pitch, int16_t yaw, int16_t speed)
{
  ...
  int16_t actuator[2];
  MotorCal_t* MotorCal;
  actuator[0] = -thrust + speed - pitch + roll - yaw;
  actuator[1] = thrust -speed + pitch + roll - yaw;

  MotorCal = GetMotorCal();
  actuator[0] = (actuator[0] + MotorCal->MotorOffset[0])*MotorCal->MotorScale[0];
  actuator[1] = (actuator[1] + MotorCal->MotorOffset[1])*MotorCal->MotorScale[1];
  

 
  if(actuator[0]>0) { 
    BLDC_MOTOR[0].ctrl = 2;
    BLDC_MOTOR[0].pwm = actuator[0];
    motorPowerM[0] = BLDC_MOTOR[0].pwm;
  } 
  

 
  else if(actuator[0]<-0) { 
  ...
  if(actuator[1]>0) { 
    BLDC_MOTOR[1].ctrl = 2;
    BLDC_MOTOR[1].pwm = actuator[1];
    motorPowerM[1] = BLDC_MOTOR[1].pwm;
  } 
  

 
  else if(actuator[1]<-0) { 
  ...
  switch(BLDC_MOTOR[0].ctrl)
  {
    case 0:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((13)<<2)))) = 0;
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((12)<<2)))) = 0;
    break;
    case 1:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((13)<<2)))) = 0;
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((12)<<2)))) = 1;
    break;
  case 2:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((13)<<2)))) = 1;
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((12)<<2)))) = 0;
    break;
  default:
    (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(4))) + ((13)<<2)))) = 1;
  ...
  switch(BLDC_MOTOR[1].ctrl)
  {
    case 0:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(3))) + ((7)<<2)))) = 0;
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(5))) + ((2)<<2)))) = 0;
    break;
    case 1:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(3))) + ((7)<<2)))) = 0;
    ...
    break;
    case 2:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(3))) + ((7)<<2)))) = 1;
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(5))) + ((2)<<2)))) = 0;
    break;
    default:
      (*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(3))) + ((7)<<2)))) = 1;
  ...
  motorsSetRatio(0, BLDC_MOTOR[0].pwm);
  motorsSetRatio(1, BLDC_MOTOR[1].pwm);
}
#line 424 "stabilizer.c"
void GetMotorPower(int16_t* MotorPower)
{
	MotorPower[0] = (uint16_t)motorPowerM[0];
	MotorPower[1] = (uint16_t)motorPowerM[1];

  MotorPower[2] = BLDC_MOTOR[0].ctrl;
  MotorPower[3] = BLDC_MOTOR[1].ctrl;
#line 439 "stabilizer.c"
}
_Bool IsMotorSpin() 
{
	uint8_t i;
	for(i=0; i<6; i++) {
		if((uint16_t)motorPowerM[i]<1200)
			return 0;
	}
	return 1;
}
...
void stabilizer()
{
  ...
  eulerYawActual = Euler[2];
	...
	controllerCorrectAttitudePID(eulerRollActual, eulerPitchActual, eulerYawActual,
				eulerRollDesired, eulerPitchDesired, -eulerYawDesired,				&rollRateDesired, &pitchRateDesired, &yawRateDesired);

	

	
#line 530 "stabilizer.c"
	commanderGetThrust();
  ...
  if((GetSensorCalState()&(1<<1))&& (motor_enable==1)) 
    distributePower(Actuator.actuatorThrust, Actuator.actuatorRoll, Actuator.actuatorPitch, -Actuator.actuatorYaw, 0 );
  else
    distributePower(0, 0, 0, 0, 0);
  

 
#line 565 "stabilizer.c"
}
