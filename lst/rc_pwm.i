...
#line 54 "RC_pwm.c"
uint16_t* rcValuePwm;
static uint8_t rcChannelPWM[6]  = {1, 2, 3, 0, 4,5};
static uint8_t RX_PORTB_PINS[6] = {(1<<0),(1<<1),(1<<6),(1<<3),(1<<4),(1<<5)};  
...
void RC_PWM_Enable(char enable)
{
	if(enable) {
		...
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 4, 0x00010001UL);
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 5, 0x00010001UL);
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 3, 0x00010001UL);
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 6, 0x00010001UL);
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 1, 0x00010001UL);
		GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0, 0x00010001UL);
...
{
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL &= ~((0xful << (16)) | (0xful << (20)) | (0xful << (24)) | (0xful << (28)));
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL |= ((0ul << (28)) | (0ul << (24)) | (0ul << (16)) | (0ul << (20)));
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL &= ~(0xful << (12));	
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPD_MFPL |= (0ul << (12));

	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000001, 0x3UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000002, 0x3UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000040, 0x3UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000008, 0x3UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000010, 0x3UL);
...
_Bool IsPWMRCConnected()
{
	if(rcValuePwm[0]<1000)
		return 0;
	else 
	return 1;
}
...
{
	return ((readPwmRC(3) - 1090) + (1355 - 250));
}
int16_t GetPWMAltitude()
{
	return (readPwmRC(3) - 250);
}
