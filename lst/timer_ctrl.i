...
#line 26 "Timer_Ctrl.c"
#line 27 "Timer_Ctrl.c"
#line 1 "AltHold.h"
...
_Bool IsSSVRCConnected(void);
_Bool IsSSVReceiverConnected(void);
int16_t GetSSVThrust(void);
int16_t GetSSVAltitude(void);
void SetRemoteControl(void);
#line 30 "Timer_Ctrl.c"
#line 1 "ssv7241.h"
...
#line 31 "Timer_Ctrl.c"
typedef struct {
	int lastTime;
	int interval0;
	int currentTime; 
}Chronograph_T;
Chronograph_T Chronograph[4];
...
{
#line 90 "Timer_Ctrl.c"
	if((tick_counter_100u%10000)==0) {




		UPDATE_DT = 0.002f;
#line 103 "Timer_Ctrl.c"
		
#line 111 "Timer_Ctrl.c"
	}
...
{
	if(TIMER_GetIntFlag(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000))) == 1) {
		 
		TIMER_ClearIntFlag(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)));
		u32Timer2Cnt+=10;
	}
}
...
{
	if(enable)
		TIMER_EnableInt(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)));
	else
		TIMER_DisableInt(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)));
}
#line 235 "Timer_Ctrl.c"
...
void TIMER_Init()
{
	...
	TIMER_Open(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)), (1UL << (27)), 100000);
	TIMER_EnableInt(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)));
	NVIC_SetPriority (TMR2_IRQn, (1<<4) - 1);
	 
	NVIC_EnableIRQ(TMR2_IRQn);
	 
	TIMER_Start(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x11000)));
	...
	TIMER_Open(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x10000) + 0x20)), (1UL << (27)), 1000);
	TIMER_EnableInt(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x10000) + 0x20)));
	 
	NVIC_EnableIRQ(TMR1_IRQn);
	
		 
	CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((5)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((20) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
	CLK_SetModuleClock(((((1) & 0x03) << 30)|((((5)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((20) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x7UL<<(20)), 0);
	((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x11000)+ 0x20))->CTL = (1UL << (27)) | (21);
  ((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x11000)+ 0x20))->CMP = 0xFFFFFF;
	TIMER_Start(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x11000)+ 0x20)));
	
#line 280 "Timer_Ctrl.c"

#line 290 "Timer_Ctrl.c"
}
