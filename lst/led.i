...
{
    if(TIMER_GetIntFlag(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x10000) + 0x20))) == 1)
    {
         
        TIMER_ClearIntFlag(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x10000) + 0x20)));
				LED_cnt++;
				if (LED_cnt<(Blink*100))
						((GPIO_T *) ((0x40000000UL) + 0x04000))->DOUT = (LED1_R<<3)|(LED1_R<<6)|(LED1_G<<2)|(LED1_G<<5)|(LED1_B<<1)|(LED1_B<<4);
				else 
						((GPIO_T *) ((0x40000000UL) + 0x04000))->DOUT = 0;
				if (LED_cnt==1000)
						LED_cnt=0;
    }
}
...
void Laser_init(void)
{
		...
		(*((volatile uint32_t *)((((0x40000000UL) + 0x04800)+(0x40*(2))) + ((10)<<2))))=0;
}
char GetLedState()
{
	return ledState;
...
void LED_Init(void)
{
		GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000)),(0x00000002|0x00000004|0x00000008|0x00000010|0x00000020|0x00000040),0x1UL);
		((GPIO_T *) ((0x40000000UL) + 0x04000))->DOUT = 0;
		 
		TIMER_Start(((TIMER_T *) ((((0x40000000UL) + 0x00040000) + 0x10000) + 0x20)));		
