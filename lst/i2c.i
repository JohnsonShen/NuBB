...
{
    i2c->BUSCTL |= (0x1ul << (9));
    i2c->BUSTOUT = (((us * u32Hclk) >> 2) / 1000000) - 1;
}
...
void I2C_SMBusTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    ...
    i2c->TOCTL &= ~(0x1ul << (2));
    u32Div = ((ms * u32Pclk) / (16 * 1024 * 1000)) - 1;
    if(u32Div <= 0xFF)
    {
        i2c->BUSTOUT = u32Div;
        return;
    ...
    i2c->BUSTOUT = (((ms * u32Pclk) / (16 * 1024 * 4 * 1000)) - 1) & 0xFF; 
}
...
void I2C_SMBusClockLoTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    ...
    i2c->TOCTL |= (0x1ul << (2));
    i2c->CLKTOUT = (((ms * u32Pclk) / (16 * 1024 * 4 * 1000)) - 1) & 0xFF; 
}
