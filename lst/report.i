...
#line 629 "..\\..\\..\\Library\\StdDriver\\inc\\spi.h"
...
void report_motor_speed()
{
  ...
  motorSpeed[1] = GetMoveSpeedL();
  motorSpeed[0] = GetMoveSpeedR();
	if (report_format == 1) {
...
void report_sensors()
{
	...
	else if (report_mode == 7) {
		report_rate_pid();
	}
	else if (report_mode == 10) {
		report_althold_pid();
	}
	else if (report_mode == 8) {
		report_velocity();
	}
	else if (report_mode == 9) {
		report_rc_status();
	}
	else if (report_mode == 11) {



	}
	else if (report_mode == 12) {
		report_mode_status();
	}
	else if (report_mode == 13) {
		report_flash_status();
	}
#line 456 "Report.c"
  else if (report_mode == 15) {
		report_motor_speed();
  }
  else if (report_mode == 16) {
