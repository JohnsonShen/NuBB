...
void computePwmRC()
{
	static uint16_t rcData4Values[6][4], rcDataMean[6];
...
void armDetect()
{
	if(motorArm==0) {
		...
		if((rcData[3]<1100)&&(rcData[2]>1700))

		{
			arm_count++;
			if(arm_count*20>1000)
				MotorArm();
		}
		else
			arm_count = 0;
