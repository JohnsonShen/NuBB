...
volatile    uint8_t             IR2_State = 0;       
volatile    uint8_t             IR2_LDC_Ready = 0;   
volatile    uint8_t             IR2_CTC_Ready = 0;   
volatile    uint8_t             IR2_CTC0 = 0;        
volatile    uint8_t             IR2_CTC1 = 0;        
volatile    uint8_t             IR2_DAC = 0;         
volatile    uint8_t             IR2_DAB = 0;         
...
void PWM1P1_IRQHandler(void)
{
    uint32_t TDR1_tmp,TDR2_tmp;
		if(PWM_GetCaptureIntFlag(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 2) ==3)
		{	
				TDR1_tmp = 0xFFFF - (*(volatile uint32_t *) (&((((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)))->FCAPDAT0) + 2 * (2)));
				PWM_ClearCaptureIntFlag(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 2, (0x100UL));
				IrDa_NEC_Rx(TDR1_tmp);
		}
		if(PWM_GetCaptureIntFlag(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 3) ==3)
		{	
				TDR2_tmp = 0xFFFF - (*(volatile uint32_t *) (&((((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)))->FCAPDAT0) + 2 * (3)));
				PWM_ClearCaptureIntFlag(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 3, (0x100UL));
...
void Mark(uint8_t N)
{
    ...
    PWM_EnableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x1UL));
    TIMER_Delay(((TIMER_T *) (((0x40000000UL) + 0x00040000) + 0x10000)), 560 * N);
    PWM_DisableOutput(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x1UL));
...
void IR_init(void)
{
    ...
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH = ((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH & (~(0xful << (4))) & (~(0xful << (12))) & (~(0xful << (16)));
    ((SYS_T *) ((0x40000000UL) + 0x00000))->GPC_MFPH |= ((6ul << (4))|(6ul << (12))|(6ul << (16)));
    ...
    PWM_ConfigOutputChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 0, 38000, 30);

     
    PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x1UL));


     
    PWM_ConfigCaptureChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 2, 1000, 0);
		PWM_ConfigCaptureChannel(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 3, 1000, 0);

     
    PWM_EnableCaptureInt(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 2, (0x100UL));
		PWM_EnableCaptureInt(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), 3, (0x100UL));

     
    NVIC_EnableIRQ(PWM1P1_IRQn);

     
    PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x4UL));
		PWM_Start(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x8UL));

     
    ((GPIO_T *) ((0x40000000UL) + 0x04080))->SMTEN |= (0x1ul << (11));
		((GPIO_T *) ((0x40000000UL) + 0x04080))->SMTEN |= (0x1ul << (12));

     
    PWM_EnableCapture(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x4UL));
		PWM_EnableCapture(((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000)), (0x8UL));

     
    ((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000))->CAPCTL |= (0x1ul << (26));
		((PWM_T *) (((0x40000000UL) + 0x00040000) + 0x19000))->CAPCTL |= (0x1ul << (27));
