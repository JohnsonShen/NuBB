...
int kbnumbers(void)
{
	return ((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFOSTS>>8)&0x3f);  
}
...
void Serial_write(char* id, int num)
{
	...
	for(i=0; i<num; i++) {
		while(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->FIFOSTS & (0x1ul << (23)));
		((UART_T *) (((0x40000000UL) + 0x00040000) + 0x30000))->DAT = id[i];
	}
}
int gpsnumbers(void)
{
	return ((((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000))->FIFOSTS>>8)&0x3f);  
}
...
char GPS_read(void)
{
	return (((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000))->DAT);
}
void GPS_write(char* id, int num, int delay)
{
	int i;
	for(i=0; i<num; i++) {
		while(((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000))->FIFOSTS & (0x1ul << (23)));
		((UART_T *) (((0x40000000UL) + 0x00040000) + 0x31000))->DAT = id[i];
		if(delay)
			DelayMsec(delay); 
	}
}
