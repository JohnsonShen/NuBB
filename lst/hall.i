...
void HALL_init()
{
	...
	((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL = (((SYS_T *) ((0x40000000UL) + 0x00000))->GPB_MFPL & (~(0xful << (0))) & (~(0xful << (12))));
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000001, 0x0UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000002, 0x0UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0x00000008, 0x0UL);
	GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04080)), 0x00000008, 0x0UL);
...
void HALL_getSpeed(int16_t* moveSpeed)
{
	...
	GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 0, 0x00010000UL);
	GPIO_EnableInt(((GPIO_T *) ((0x40000000UL) + 0x04040)), 3, 0x00010000UL);
